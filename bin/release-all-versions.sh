#!/usr/bin/env bash
#
# Generate FluentCRM stubs for all available versions.
#
# This script:
# 1. Fetches all available FluentCRM versions from WordPress.org
...
while IFS= read -r VERSION; do
    ...
    git commit -m "Generate stubs for FluentCRM ${VERSION}" || true
    git tag "v${VERSION}"
